    ...
    <body class="sb-nav-fixed" style="background: #e9ecef;">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="inicio.php">
                <img src="../img/icono.png" alt="" width="50px" class="ml-5">
            </a>
            ...
            <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="../procesos/usuario/salir.php">Salir de <?php echo $nombre ?></a>
                    </div>
                </li>
            </ul>
        </nav>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="small">Sesión como: <?php echo $nombre ?> </div>
                    </div>
                </nav>
            </div>
