...
<html lang="es">
    ...
    <body class="sb-nav-fixed" style="background: #e9ecef;">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="https://sistemafranco.000webhostapp.com/vistas/inicio">
            ...
            <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="../procesos/usuario/salir">Salir de <?php echo $nombre ?></a>
                    </div>
                </li>
            </ul>
        </nav>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <a class="nav-link" href="https://sistemafranco.000webhostapp.com/vistas/inicio">
                                <div class="sb-nav-link-icon"><i class="fas fa-home"></i></div>
                                Inicio
                            </a>
                            <a class="nav-link" href="https://sistemafranco.000webhostapp.com/vistas/categorias.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-clipboard"></i></div>
                                Categorías
                            </a>
                            <a class="nav-link" href="https://sistemafranco.000webhostapp.com/vistas/gestor.php">
